...
#define Button_ch7_Port GPIOA
#define Button_ch7_Pin GPIO_Pin_10
#define Button_ch7_Inverted 1
#define Button_ch7_NeedPullDown 0

#define Button_ch8_Port GPIOA
#define Button_ch8_Pin GPIO_Pin_9
#define Button_ch8_Inverted 1
#define Button_ch8_NeedPullDown 0
...
void input_int()
{
	...
	if ((Button_ch1_Inverted && (GPIO_ReadInputDataBit(Button_ch1_Port, Button_ch1_Pin) == 0)) || (!Button_ch1_Inverted && (GPIO_ReadInputDataBit(Button_ch1_Port, Button_ch1_Pin) == 1)))
		input_button_state[0] |= 1;
#endif
#ifdef Button_ch2_Port
	input_button_state[1] <<= 1;
	if ((Button_ch2_Inverted && (GPIO_ReadInputDataBit(Button_ch2_Port, Button_ch2_Pin) == 0)) || (!Button_ch2_Inverted && (GPIO_ReadInputDataBit(Button_ch2_Port, Button_ch2_Pin) == 1)))
		input_button_state[1] |= 1;
#endif
#ifdef Button_ch3_Port
	input_button_state[2] <<= 1;
	if ((Button_ch3_Inverted && (GPIO_ReadInputDataBit(Button_ch3_Port, Button_ch3_Pin) == 0)) || (!Button_ch3_Inverted && (GPIO_ReadInputDataBit(Button_ch3_Port, Button_ch3_Pin) == 1)))
		input_button_state[2] |= 1;
#endif
#ifdef Button_ch4_Port
	input_button_state[3] <<= 1;
	if ((Button_ch4_Inverted && (GPIO_ReadInputDataBit(Button_ch4_Port, Button_ch4_Pin) == 0)) || (!Button_ch4_Inverted && (GPIO_ReadInputDataBit(Button_ch4_Port, Button_ch4_Pin) == 1)))
		input_button_state[3] |= 1;
#endif
#ifdef Button_ch5_Port
	input_button_state[4] <<= 1;
	if ((Button_ch5_Inverted && (GPIO_ReadInputDataBit(Button_ch5_Port, Button_ch5_Pin) == 0)) || (!Button_ch5_Inverted && (GPIO_ReadInputDataBit(Button_ch5_Port, Button_ch5_Pin) == 1)))
		input_button_state[4] |= 1;
#endif
#ifdef Button_ch6_Port
	input_button_state[5] <<= 1;
	if ((Button_ch6_Inverted && (GPIO_ReadInputDataBit(Button_ch6_Port, Button_ch6_Pin) == 0)) || (!Button_ch6_Inverted && (GPIO_ReadInputDataBit(Button_ch6_Port, Button_ch6_Pin) == 1)))
		input_button_state[5] |= 1;
#endif
#ifdef Button_ch7_Port
	input_button_state[6] <<= 1;
	if ((Button_ch7_Inverted && (GPIO_ReadInputDataBit(Button_ch7_Port, Button_ch7_Pin) == 0)) || (!Button_ch7_Inverted && (GPIO_ReadInputDataBit(Button_ch7_Port, Button_ch7_Pin) == 1)))
		input_button_state[6] |= 1;
#endif
#ifdef Button_ch8_Port
	input_button_state[7] <<= 1;
	if ((Button_ch8_Inverted && (GPIO_ReadInputDataBit(Button_ch8_Port, Button_ch8_Pin) == 0)) || (!Button_ch8_Inverted && (GPIO_ReadInputDataBit(Button_ch8_Port, Button_ch8_Pin) == 1)))
		input_button_state[7] |= 1;
#endif
	...
	if (GPIO_ReadInputDataBit(Counter_ch1_Port, Counter_ch1_Pin) == 1)
		input_counter_state[0] |= 1;
#endif
#ifdef Counter_ch2_Port
	input_counter_state[1] <<= 1;
	if (GPIO_ReadInputDataBit(Counter_ch2_Port, Counter_ch2_Pin) == 1)
		input_counter_state[1] |= 1;
#endif
#ifdef Counter_ch3_Port
	input_counter_state[2] <<= 1;
	if (GPIO_ReadInputDataBit(Counter_ch3_Port, Counter_ch3_Pin) == 1)
		input_counter_state[2] |= 1;
#endif
#ifdef Counter_ch4_Port
	input_counter_state[3] <<= 1;
	if (GPIO_ReadInputDataBit(Counter_ch3_Port, Counter_ch4_Pin) == 1)
		input_counter_state[3] |= 1;
#endif
	...
	if ((BinarySensor_ch1_Inverted && (GPIO_ReadInputDataBit(BinarySensor_ch1_Port, BinarySensor_ch1_Pin) == 0)) || (!BinarySensor_ch1_Inverted && (GPIO_ReadInputDataBit(BinarySensor_ch1_Port, BinarySensor_ch1_Pin) == 1)))
		input_binary_sensor_state[0] |= 1;
#endif
#ifdef BinarySensor_ch2_Port
	input_binary_sensor_state[1] <<= 1;
	if ((BinarySensor_ch2_Inverted && (GPIO_ReadInputDataBit(BinarySensor_ch2_Port, BinarySensor_ch2_Pin) == 0)) || (!BinarySensor_ch2_Inverted && (GPIO_ReadInputDataBit(BinarySensor_ch2_Port, BinarySensor_ch2_Pin) == 1)))
		input_binary_sensor_state[1] |= 1;
#endif
#ifdef BinarySensor_ch3_Port
	input_binary_sensor_state[2] <<= 1;
	if ((BinarySensor_ch3_Inverted && (GPIO_ReadInputDataBit(BinarySensor_ch3_Port, BinarySensor_ch3_Pin) == 0)) || (!BinarySensor_ch3_Inverted && (GPIO_ReadInputDataBit(BinarySensor_ch3_Port, BinarySensor_ch3_Pin) == 1)))
		input_binary_sensor_state[2] |= 1;
#endif
#ifdef BinarySensor_ch4_Port
	input_binary_sensor_state[3] <<= 1;
	if ((BinarySensor_ch4_Inverted && (GPIO_ReadInputDataBit(BinarySensor_ch4_Port, BinarySensor_ch4_Pin) == 0)) || (!BinarySensor_ch4_Inverted && (GPIO_ReadInputDataBit(BinarySensor_ch4_Port, BinarySensor_ch4_Pin) == 1)))
		input_binary_sensor_state[3] |= 1;
#endif
#ifdef BinarySensor_ch5_Port
	input_binary_sensor_state[4] <<= 1;
	if ((BinarySensor_ch5_Inverted && (GPIO_ReadInputDataBit(BinarySensor_ch5_Port, BinarySensor_ch5_Pin) == 0)) || (!BinarySensor_ch5_Inverted && (GPIO_ReadInputDataBit(BinarySensor_ch5_Port, BinarySensor_ch5_Pin) == 1)))
		input_binary_sensor_state[4] |= 1;
#endif
#ifdef BinarySensor_ch6_Port
	input_binary_sensor_state[5] <<= 1;
	if ((BinarySensor_ch6_Inverted && (GPIO_ReadInputDataBit(BinarySensor_ch6_Port, BinarySensor_ch6_Pin) == 0)) || (!BinarySensor_ch6_Inverted && (GPIO_ReadInputDataBit(BinarySensor_ch6_Port, BinarySensor_ch6_Pin) == 1)))
		input_binary_sensor_state[5] |= 1;
#endif
#ifdef BinarySensor_ch7_Port
	input_binary_sensor_state[6] <<= 1;
	if ((BinarySensor_ch7_Inverted && (GPIO_ReadInputDataBit(BinarySensor_ch7_Port, BinarySensor_ch7_Pin) == 0)) || (!BinarySensor_ch7_Inverted && (GPIO_ReadInputDataBit(BinarySensor_ch7_Port, BinarySensor_ch7_Pin) == 1)))
		input_binary_sensor_state[6] |= 1;
#endif
#ifdef BinarySensor_ch8_Port
	input_binary_sensor_state[7] <<= 1;
	if ((BinarySensor_ch8_Inverted && (GPIO_ReadInputDataBit(BinarySensor_ch8_Port, BinarySensor_ch8_Pin) == 0)) || (!BinarySensor_ch8_Inverted && (GPIO_ReadInputDataBit(BinarySensor_ch8_Port, BinarySensor_ch8_Pin) == 1)))
		input_binary_sensor_state[7] |= 1;
#endif
...
{
	if (sensor < 1 || sensor > INPUT_NUM_OF_BINARY_SENSOR)
		return 0;
...
{
	if (input < 1 || input > INPUT_NUM_OF_ANALOG_INPUT)
		return 0;
...
void input_add_data_to_str(char *body)
{
	...
	for (uint8_t i = 0; i < INPUT_NUM_OF_BINARY_SENSOR; i++)
	{
		...
		strcat(body, temp);
		if ((i + 1) == INPUT_NUM_OF_BINARY_SENSOR)
			body[strlen(body) - 1] = '\0';
	}
	...
	for (uint8_t i = 0; i < INPUT_NUM_OF_ANALOG_INPUT; i++)
	{
		...
		strcat(body, temp);
		if ((i + 1) == INPUT_NUM_OF_ANALOG_INPUT)
			body[strlen(body) - 1] = '\0';
	}
	strcat(body, "]");
}
