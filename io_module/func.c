...
uint8_t io_module_get_device_index()
{
	...
	while (1)
	{
		if (io_module_button_pressed(12))
		{
			index += 1;
			LEDON(1);
		}
		if (io_module_button_pressed(11))
		{
			index += 2;
			LEDON(2);
		}
		if (io_module_button_pressed(10))
		{
			index += 4;
			LEDON(3);
		}
		if (io_module_button_pressed(9))
		{
			index += 8;
			LEDON(4);
		}
		if (io_module_button_pressed(16))
		{
			index += 16;
			LEDON(5);
		}
		if (io_module_button_pressed(15))
		{
			index += 32;
			LEDON(6);
		}
